...
import Game_WPresenter from "./Game_WPresenter";
import storageRef from "../../../../firebase";
import useInput from "../../../../Hooks/useInput";
import { useQuery, useMutation } from "react-apollo-hooks";
import { CREATE_GAME_BOARD } from "./Game_WQueries";
import { toast } from "react-toastify";

const Game_WContainer = ({ history }) => {
 ////////////// - USE CONTEXT- ///////////////
 ...
 ///////////// - USE MUTATION- /////////////
 const [GameMutation] = useMutation(CREATE_GAME_BOARD);
...
export default Game_WContainer;
