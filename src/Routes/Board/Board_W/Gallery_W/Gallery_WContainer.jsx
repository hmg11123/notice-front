...
import Gallery_WPresenter from "./Gallery_WPresenter";
import storageRef from "../../../../firebase";
import useInput from "../../../../Hooks/useInput";
import { useQuery, useMutation } from "react-apollo-hooks";
import { CREATE_GALLERY } from "./Gallery_WQueries";
import { toast } from "react-toastify";

const Gallery_WContainer = ({ history }) => {
 ////////////// - USE CONTEXT- ///////////////
 ...
 ///////////// - USE MUTATION- /////////////
 const [GalleryMutation] = useMutation(CREATE_GALLERY);
 ...
 const writeHandler = async () => {
  const { data } = await GalleryMutation({
   variables: {
