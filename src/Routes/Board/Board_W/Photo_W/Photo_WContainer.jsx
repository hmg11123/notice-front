...
import Photo_WPresenter from "./Photo_WPresenter";
import storageRef from "../../../../firebase";
import useInput from "../../../../Hooks/useInput";
import { useQuery, useMutation } from "react-apollo-hooks";
import { CREATE_PHOTO } from "./Photo_WQueries";
import { toast } from "react-toastify";

const Photo_WContainer = ({ history }) => {
 ////////////// - USE CONTEXT- ///////////////
 ...
 ///////////// - USE MUTATION- /////////////
 const [PhotoMutation] = useMutation(CREATE_PHOTO);
 ...
 const writeHandler = async () => {
  ...
  const { data } = await PhotoMutation({
   variables: {
...
export default Photo_WContainer;
