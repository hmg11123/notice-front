  ...
  <Wrapper>
   <Wrapper>
    ...
    <ContentBox width={`50%`} height={`100%`}>
     ...
     <Wrapper ju={`flex-start`}>
      <Wrapper height={`10%`} fs={`25px`} al={`flex-start`}>
       {joinData ? joinData.title : <CircularIndeterminate />}
      </Wrapper>
      <TopBoard height={`10%`}>
       <Wrapper width={`10%`}>
        {joinData ? joinData.author : <CircularIndeterminate />}
       </Wrapper>
       <Wrapper width={`15%`}>
        {joinData ? (
         joinData.createdAt.substring(0, 10)
        ) : (
       ...
       <Wrapper width={`15%`}>
        추천수 :{joinData ? joinData.recommendation : <CircularIndeterminate />}
       </Wrapper>
       <Wrapper width={`15%`}>
        조회수 :{joinData ? joinData.hit : <CircularIndeterminate />}
       </Wrapper>
      </TopBoard>
...
export default Join_DPresenter;
