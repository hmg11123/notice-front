  ...
  <Wrapper>
   <Wrapper>
    ...
    <ContentBox width={`50%`} height={`100%`}>
     ...
     <Wrapper ju={`flex-start`}>
      <Wrapper height={`10%`} fs={`25px`} al={`flex-start`}>
       {hobbyData ? hobbyData.title : <CircularIndeterminate />}
      </Wrapper>
      <TopBoard height={`10%`}>
       <Wrapper width={`10%`}>
        {hobbyData ? hobbyData.author : <CircularIndeterminate />}
       </Wrapper>
       <Wrapper width={`15%`}>
        {hobbyData ? (
         hobbyData.createdAt.substring(0, 10)
        ) : (
       ...
       <Wrapper width={`15%`}>
        추천수 :
        {hobbyData ? hobbyData.recommendation : <CircularIndeterminate />}
       </Wrapper>
       <Wrapper width={`15%`}>
        조회수 :{hobbyData ? hobbyData.hit : <CircularIndeterminate />}
       </Wrapper>
      </TopBoard>
      <Wrapper al={`flex-start`} ju={`flex-start`} margin={`30px`}>
       {hobbyData ? (
        <Wrapper>{hobbyData.description}</Wrapper>
       ) : (
        <CircularIndeterminate />
       )}
       {hobbyData ? (
...
export default Hobby_DPresenter;
