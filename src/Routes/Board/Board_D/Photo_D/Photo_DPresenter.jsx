  ...
  <Wrapper>
   <Wrapper>
    ...
    <ContentBox width={`50%`} height={`100%`}>
     ...
     <Wrapper ju={`flex-start`}>
      <Wrapper height={`10%`} fs={`25px`} al={`flex-start`}>
       {photoData ? photoData.title : <CircularIndeterminate />}
      </Wrapper>
      <TopBoard height={`10%`}>
       <Wrapper width={`10%`}>
        {photoData ? photoData.author : <CircularIndeterminate />}
       </Wrapper>
       <Wrapper width={`15%`}>
        {photoData ? (
         photoData.createdAt.substring(0, 10)
        ) : (
       ...
       <Wrapper width={`10%`}>
        조회수 :{photoData ? photoData.hit : <CircularIndeterminate />}
       </Wrapper>
       <Wrapper width={`10%`}>댓글</Wrapper>
      </TopBoard>
      <Wrapper margin={`30px`}>
       <Wrapper al={`flex-end`}></Wrapper>
       {photoData ? (
        photoData.imgPath === "-" ? (
         <Blank></Blank>
        ) : (
       ...
       {photoData ? (
        <Wrapper>{photoData.description}</Wrapper>
       ) : (
        <CircularIndeterminate />
       )}
      </Wrapper>
...
export default Photo_DPresenter;
