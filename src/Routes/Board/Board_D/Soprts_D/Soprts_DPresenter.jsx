  ...
  <Wrapper>
   <Wrapper>
    ...
    <ContentBox width={`50%`} height={`100%`}>
     ...
     <Wrapper ju={`flex-start`}>
      <Wrapper height={`10%`} fs={`25px`} al={`flex-start`}>
       {soprtsData ? soprtsData.title : <CircularIndeterminate />}
      </Wrapper>
      <TopBoard height={`10%`}>
       <Wrapper width={`10%`}>
        {soprtsData ? soprtsData.author : <CircularIndeterminate />}
       </Wrapper>
       <Wrapper width={`15%`}>
        {soprtsData ? (
         soprtsData.createdAt.substring(0, 10)
        ) : (
       ...
       <Wrapper width={`15%`}>
        추천수 :
        {soprtsData ? soprtsData.recommendation : <CircularIndeterminate />}
       </Wrapper>
       <Wrapper width={`15%`}>
        조회수 :{soprtsData ? soprtsData.hit : <CircularIndeterminate />}
       </Wrapper>
      </TopBoard>
      <Wrapper al={`flex-start`} ju={`flex-start`} margin={`30px`}>
       {soprtsData ? (
        <Wrapper>{soprtsData.description}</Wrapper>
       ) : (
        <CircularIndeterminate />
       )}
       {soprtsData ? (
...
export default Soprts_DPresenter;
