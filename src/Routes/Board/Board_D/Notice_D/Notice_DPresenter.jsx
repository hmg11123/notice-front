  ...
  <Wrapper>
   <Wrapper>
    ...
    <ContentBox width={`50%`} height={`100%`}>
     ...
     <Wrapper ju={`flex-start`}>
      <Wrapper height={`10%`} fs={`25px`} al={`flex-start`}>
       {noticeData ? noticeData.title : <CircularIndeterminate />}
      </Wrapper>
      <TopBoard height={`10%`}>
       <Wrapper width={`10%`}>
        {noticeData ? noticeData.author : <CircularIndeterminate />}
       </Wrapper>
       <Wrapper width={`15%`}>
        {noticeData ? (
       ...
       <Wrapper width={`15%`}>
        추천수 :
        {noticeData ? noticeData.recommendation : <CircularIndeterminate />}
       </Wrapper>
       <Wrapper width={`15%`}>
        조회수 :{noticeData ? noticeData.hit : <CircularIndeterminate />}
       </Wrapper>
      </TopBoard>
      <Wrapper al={`flex-start`} ju={`flex-start`} margin={`30px`}>
       {noticeData ? (
        <Wrapper>{noticeData.description}</Wrapper>
       ) : (
        <CircularIndeterminate />
       )}
       {noticeData ? (
...
export default Notice_DPresenter;
